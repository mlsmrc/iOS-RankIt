...
- (void) DownloadPolls {
    ...
    /* Prova*/
    [Connection scaricaPollsWithPollId:@"" andUserId:@"693333a879834e2888fffcdadc0d127bee9d18e9583c45859ffb6397625afd44" andStart:@""];
    /**/
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        /* Eliminazione del poll direttamente dal server */
        ConnectionToServer *conn = [[ConnectionToServer alloc] init];
        Poll *p = [allVotedPollsDetails objectAtIndex:indexPath.row];
        [conn deletePollWithPollId:[NSString stringWithFormat:@"%d",p.pollId] AndUserID:@"693333a879834e2888fffcdadc0d127bee9d18e9583c45859ffb6397625afd44"];
        
        /* Messaggio di eliminazione */
        UIAlertView *alert = [UIAlertView alloc];
        alert = [alert initWithTitle:@"Messaggio" message:@"Poll eliminato con successo!" delegate:self cancelButtonTitle:nil otherButtonTitles:@"Ok", nil];
        [alert show];

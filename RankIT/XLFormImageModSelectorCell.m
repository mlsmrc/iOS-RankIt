...
@interface XLFormImageModSelectorCell() <UIActionSheetDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>
...
@implementation XLFormImageModSelectorCell {
...
+ (void) load {
    ...
    [XLFormViewController.cellClassesForRowDescriptorTypes setObject:[XLFormImageModSelectorCell class] forKey:XLFormImageModSelectorCellCustom];
